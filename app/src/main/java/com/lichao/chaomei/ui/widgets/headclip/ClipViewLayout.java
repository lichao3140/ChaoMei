package com.lichao.chaomei.ui.widgets.headclip;
...
import static com.lichao.chaomei.utils.FileUtils.getRealFilePathFromUri;

/**
 * Created by ChaoLi on 2018/5/15 0015 - 18:46
 * Email: lichao3140@gmail.com
 * Version: v1.0  头像上传原图裁剪容器
 */
public class ClipViewLayout extends RelativeLayout {
    ...
    public void initSrcPic(Uri uri) {
        ...
        Logger.d("**********clip_view uri*******  " + uri);
        String path = getRealFilePathFromUri(getContext(), uri);
        Logger.d("**********clip_view path*******  " + path);
