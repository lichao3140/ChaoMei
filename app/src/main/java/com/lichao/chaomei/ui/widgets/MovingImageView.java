...
/**
 * Created by ChaoLi on 2018/5/14 0014 - 8:53
 * Email: lichao3140@gmail.com
 * Version: v1.0  自定义可以背景滚动的ImageView
 */
...
public class MovingImageView extends ImageView {
    ...
    public MovingImageView(Context context, @Nullable AttributeSet attrs, int defStyle) {
