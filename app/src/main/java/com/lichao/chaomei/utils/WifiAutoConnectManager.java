...
/**
 * Created by ChaoLi on 2018/5/14 0014 - 12:13
 * Email: lichao3140@gmail.com
 * Version: v1.0  兼容Android 6.0以上手机连接wifi
 */
        ...
        public void run() {
            ...
            if (tempConfig != null) {
                ...
                WifiConfiguration wifiConfig = createWifiInfo(ssid, password,
                        type);
                if (wifiConfig == null) {
                    Logger.d("wifiConfig is null!");
                    return;
                }

                int netID = wifiManager.addNetwork(wifiConfig);
                boolean enabled = wifiManager.enableNetwork(netID, true);
                Logger.d("enableNetwork status enable=" + enabled);
                boolean connected = wifiManager.reconnect();
                Logger.d("enableNetwork connected=" + connected);
            }
